    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="#page-top" class="navbar-brand page-scroll">
                <img src="<?= $media_path ?>/assets/img/logo-white.svg" alt="Logo" class="logo">
                <img src="<?= $media_path ?>/assets/img/logo.svg" alt="Logo" class="logo-short">
            </a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    ...
                    <form method="post" class="search-form animated fadeIn" onsubmit="return doSearch();" autocomplete="off">
                        ...
                        <?php foreach($search_autocomplete as $key => $value): ?>
