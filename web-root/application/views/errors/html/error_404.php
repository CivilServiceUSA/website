...
<head>
    ...
    <title>Civil Services - Error 404</title>
    ...
    <meta name="description" content="Civil Services - Error 404">
    ...
    <meta name="twitter:title" content="Civil Services - Error 404">
    <meta name="twitter:site" content="@CivilServiceUSA">
    <meta name="twitter:creator" content="@CivilServiceUSA">
    <meta name="twitter:description" content="Civil Services - Error 404">
    <meta name="twitter:image" content="/assets/img/app-image.jpg">
    <meta name="twitter:image:alt" content="Civil Services - Error 404">
    <meta name="twitter:domain" content="civil.services">

    <!-- Open Graph Metadata -->
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Civil Services - Error 404">
    <meta property="og:url" content="https://civil.services">
    <meta property="og:image" content="/assets/img/app-image.jpg">
    <meta property="og:site_name" content="Civil Services">
    <meta property="og:description" content="Civil Services - Error 404">

    <!-- Dublin Core Metadata -->
    <meta name="dc:language" content="en_US">
    <meta name="dc:title" content="Civil Services - Error 404">
    <meta name="dc:source" content="https://civil.services">
    <meta name="dc:description" content="Civil Services - Error 404">

    <!-- App Icons -->
    <link rel="shortcut icon" href="/assets/img/icons/favicon.ico">
    <link rel="apple-touch-icon" sizes="144x144" href="/assets/img/icons/favicon-retina-ipad.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/assets/img/icons/favicon-retina-iphone.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/assets/img/icons/favicon-standard-ipad.png">
    <link rel="apple-touch-icon" sizes="57x57" href="/assets/img/icons/favicon-standard-iphone.png">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="#page-top" class="navbar-brand page-scroll">
                ...
                <img src="/assets/img/logo.svg" alt="Logo" class="logo-short">
            </a>
        </div>
...
<!-- Header-->
<header data-background="/assets/img/header/civil-services-bg.jpg" class="intro intro-fullscreen">
    <!-- Intro Header-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <p class="small"><a href="https://civil.services">&copy; <?= date('Y'); ?> <i class="fa fa-heart fa-fw"></i> CIVIL.SERVICES</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
  var cb = function() {
    ...
    plugins.href = '/assets/css/plugins.css';

    var styles = document.createElement('link');
    styles.rel = 'stylesheet';
    styles.href = '/assets/css/style.css';
