...
<div class="section section-breadcrumb">
    <div class="container wow fadeIn">
        <div class="row">
            <div class="col-md-12">
                <h6 class="breadcrumb">
                    <a href="/">Home</a> / <a href="/state/{{ $state->state_name_slug }}">State</a> / {{ $state->state_name }}
                </h6>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row grid-pad">
            <div class="col-sm-6">
                ...
                <a href="/senate/state/{{ $state->state_name_slug }}">
                ...
                <a href="/senate/state/{{ $state->state_name_slug }}" class="btn btn-success btn-lg">View Senators</a>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container text-center">
        <div class="row grid-pad">
            <div class="col-sm-6 col-md-4">
                <h5>{{ $state->state_name }} Map</h5>
                <p><img src="{{ $state->map->large }}" alt="{{ $state->state_name }} Map Image" class="img-responsive center-block max-h-240" /></p>
            </div>
            <div class="col-sm-6 col-md-4">
                <h5>{{ $state->state_name }}'s State Flag</h5>
                <p><img src="{{ $state->state_flag->large }}" alt="{{ $state->state_name }}'s State Flag Image" class="img-responsive center-block max-h-240" /></p>
            </div>
            <div class="col-sm-6 col-md-4">
                <h5>{{ $state->state_name }}'s State Seal</h5>
                <p><img src="{{ $state->state_seal->large }}" alt="{{ $state->state_name }}'s State Seal Image" class="img-responsive center-block max-h-240" /></p>
            </div>
        </div>
    </div>
</section>
