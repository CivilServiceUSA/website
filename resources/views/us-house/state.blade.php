...
@section('body')
    ...
    <header data-background="{{ $state->landscape->size_1280x720 }}" class="intro introhalf">
        ...
        <div class="intro-body">
            ...
            <h4>115th United States Congress - U.S. House of Representatives</h4>
        </div>
    </header>
    ...
    <div class="section section-breadcrumb">
        <div class="container wow fadeIn">
            <div class="row">
                <div class="col-md-12">
                    <h6 class="breadcrumb">
                        <a href="/">Home</a> / <a href="/us-house">U.S. House</a> / {{ titleCase($slug)  }}
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <p>There are 435 Representatives, who sit in congressional districts which are allocated to each of the 50 U.S states. This is a list of the current {{ titleCase($slug) }} Representatives's of the United States House of Representatives (115th United States Congress).</p>
                </div>
            </div>
            <div class="row">
